...
export class EducationService {
  private educations: Education[] = [
    ...
    },
    {
      ...
      duration: '2021 - 2023',
      description:
        'Selección e implementación de sistemas de comunicación, instalación de telefonía y voz IP, diseño de redes de fibra óptica e inalámbricas, mantenimiento hardware en entornos individuales, evaluación de proyectos de conectividad y análisis del rendimiento de redes LAN mediante equipos de certificación.'
    },
  ];
